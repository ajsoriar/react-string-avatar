  ...
  renderImage() {
    ...
    if (this.props.roundShape != undefined) {
      ...
      if (this.props.cornerRadius != undefined) {
        ...
        _wrapperStyling.borderRadius = `${cornerRadius}px`;
      }

      // add this.props.style to _wrapperStyling

      const wrapperStyling = Object.assign(this.props.style, _wrapperStyling);
      ...
      if (this.props.wrapper) {
        return (
          <div className="avatar-wrapper " style={wrapperStyling}>
            {imgHtml}
          </div>
        );
      }
...
StringAvatar.defaultProps = {
  ...
  roundShape: false,
  wrapperStyling: null, // { borderRadius: 0, display: 'block', overflow: 'hidden' },
  // extraClasses: "",
  // extraImgClasses: "",
  // extraStyles: "",
  style: {},
